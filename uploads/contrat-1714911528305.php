...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240504_604bacc711348e848627_20240504223650_archive.zip';
        const ARCHIVE_SIZE       = '735670484';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '604bacc-04223650';
        const SECONDARY_PACKAGE_HASH = '1e31234-04223650';
        const VERSION            = '1.5.9';
